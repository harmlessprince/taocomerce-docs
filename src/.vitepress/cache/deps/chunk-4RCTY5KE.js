import {
  createFocusTrap
} from "./chunk-7LQZNBC3.js";
import {
  OperationBlock_default,
  ScalarDropdownButton_default,
  ScalarDropdownDivider_default,
  ScalarDropdownMenu_default,
  ScalarIconArrowUpRight_default,
  ScalarIconBookOpenText_default,
  ScalarIconBook_default,
  ScalarIconButton_default,
  ScalarIconCaretDown_default,
  ScalarIconCaretRight_default,
  ScalarIconDiscordLogo_default,
  ScalarIconEnvelopeSimple_default,
  ScalarIconFileDashed_default,
  ScalarIconFileText_default,
  ScalarIconGear_default,
  ScalarIconGithubLogo_default,
  ScalarIconHouse_default,
  ScalarIconLegacyAdapter_default,
  ScalarIconMagnifyingGlass_default,
  ScalarIconNotepad_default,
  ScalarIconPlus_default,
  ScalarIconSwap_default,
  ScalarIconUserSwitch_default,
  ScalarIconUsers_default,
  ScalarIcon_default,
  ScalarListboxCheckbox_default,
  ScalarSidebarSearchInput_default,
  ScalarSidebar_default,
  ScalarTeleportRoot_default,
  ScalarToasts_default,
  _plugin_vue_export_helper_default2 as _plugin_vue_export_helper_default,
...
// node_modules/@scalar/api-client/dist/v2/workspace-events.js
var withHook = (event, fn2, hooks) => {
  return async (args) => {
    var _a2, _b, _c2, _d2;
    const result = await ((_b = (_a2 = hooks[event]) == null ? void 0 : _a2.onBeforeExecute) == null ? void 0 : _b.call(_a2, args)) ?? args;
    await fn2(result);
    await ((_d2 = (_c2 = hooks[event]) == null ? void 0 : _c2.onAfterExecute) == null ? void 0 : _d2.call(_c2, result));
    return result;
  };
};
function initializeWorkspaceEventHandlers({ eventBus, store, hooks }) {
  ...
  eventBus.on("workspace:update:selected-example", (payload) => withHook("workspace:update:selected-example", mutators.value.workspace().workspace.updateSelectedExample, hooks)(payload));
...
// node_modules/@scalar/api-client/dist/v2/features/modal/modal-events.js
...
function initializeModalEvents({ eventBus, isSidebarOpen, requestBodyCompositionSelection, sidebarState, modalState, store }) {
  ...
  eventBus.on("scroll-to:nav-item", ({ id: id2 }) => sidebarState.handleSelectItem(id2));
  ...
  eventBus.on("ui:open:client-modal", (payload) => {
    ...
    if ("id" in payload && payload.id) {
      ...
      sidebarState.handleSelectItem(((_b = sidebarState.getEntryByLocation({
        document: isOpenApiDocument(activeDoc) ? ((_a2 = activeDoc["x-scalar-navigation"]) == null ? void 0 : _a2.id) ?? "" : "",
        path: payload.path,
...
// node_modules/@scalar/api-client/dist/v2/features/modal/helpers/resolve-route-parameters.js
...
var resolveDocumentSlug = (store, slug) => {
  ...
  return (_a2 = Object.entries(store.workspace.documents).find(([, document2]) => isOpenApiDocument(document2))) == null ? void 0 : _a2[0];
};
var resolvePath = (ctx, path, isWebhook = false) => {
  const document2 = getDocument(ctx);
  if (!document2) return;
  if (path === "default") return Object.keys(isWebhook ? document2.webhooks ?? {} : document2.paths ?? {})[0];
  return path;
};
var resolveMethod = (ctx, path, method, isWebhook = false) => {
  var _a2, _b;
  const document2 = getDocument(ctx);
  if (!document2 || !path) return;
  if (method === "default") {
    const pathItem = getResolvedPathItem(isWebhook ? (_a2 = document2.webhooks) == null ? void 0 : _a2[path] : (_b = document2.paths) == null ? void 0 : _b[path]);
    if (!pathItem) return;
...
var resolveExampleName = (ctx, operation, exampleKey) => {
  var _a2, _b;
  if (!getDocument(ctx) || (operation == null ? void 0 : operation.type) !== "operation") return "default";
  const examples = ((_a2 = operation.children) == null ? void 0 : _a2.filter(isExample)) ?? [];
  const matchingExample = examples.find((child) => child.name === exampleKey);
  if (matchingExample) return matchingExample.name;
  if (exampleKey === "default") return ((_b = examples[0]) == null ? void 0 : _b.name) ?? "default";
  return "default";
};
var resolveRouteParameters = (store, params) => {
  ...
  const traversedDocument = (_a2 = getDocument(ctx)) == null ? void 0 : _a2["x-scalar-navigation"];
  ...
  const operation = (_b = getOperationEntries(traversedDocument).get(`${path}|${method}`)) == null ? void 0 : _b.find((entry) => entry.type === (isWebhook ? "webhook" : "operation"));
  return {
    documentSlug,
    path,
    method,
...
// node_modules/@scalar/api-client/dist/v2/helpers/generate-location-id.js
var generateLocationId = ({ document: document2, path, method, example, isWebhook = false }) => {
...
// node_modules/@scalar/api-client/dist/v2/features/modal/hooks/use-modal-sidebar.js
var useModalSidebar = ({ workspaceStore, documentSlug, path, method, exampleName, isWebhook, route }) => {
  ...
  const entries = computed(() => {
    var _a2;
    const doc = workspaceStore == null ? void 0 : workspaceStore.workspace.documents[toValue(documentSlug) ?? ""];
    return isOpenApiDocument(doc) ? ((_a2 = doc["x-scalar-navigation"]) == null ? void 0 : _a2.children) ?? [] : [];
  });
  ...
  const locationIndex = computed(() => generateReverseIndex({
    ...
    getId: (node) => {
      ...
      return generateLocationId({
        document: toValue(documentSlug) ?? "",
        path: operation == null ? void 0 : operation.path,
        method: operation == null ? void 0 : operation.method,
  ...
  const handleSelectItem = (id2) => {
    const entry = state.getEntryById(id2);
    if (!entry) {
      console.warn(`Could not find sidebar entry with id ${id2} to select`);
      return;
    }
    if (entry.type === "operation" || entry.type === "example") {
      if (state.isSelected(id2)) {
        state.setExpanded(id2, !state.isExpanded(id2));
        return;
      }
      ...
      } else state.setSelected(id2);
      if (!operation) return;
      return route({
        documentSlug: toValue(documentSlug),
        path: operation.path,
        method: operation.method,
        example: (example == null ? void 0 : example.name) ?? "default"
      });
    }
    if (entry.type === "webhook") {
      state.setSelected(id2);
      return route({
        documentSlug: toValue(documentSlug),
        path: entry.name,
        method: entry.method,
...
// node_modules/@scalar/api-client/dist/v2/helpers/handle-hotkeys.js
var DEFAULT_HOTKEYS = {
  Enter: {
...
// node_modules/@scalar/api-client/dist/v2/hooks/use-global-hot-keys.js
var useGlobalHotKeys = (eventBus, layout, disableListeners) => {
  const handleKeyDown = (ev2) => {
    if (toValue(disableListeners)) return;
    handleHotkeys(ev2, eventBus, layout);
  };
  onMounted(() => window.addEventListener("keydown", handleKeyDown));
  onBeforeUnmount(() => window.removeEventListener("keydown", handleKeyDown));
};

// node_modules/@scalar/api-client/dist/v2/components/resize/Resize.vue.script.js
var draggingClassName = "scalar-dragging";
var Resize_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "Resize",
  props: { width: {} },
  emits: ["update:width"],
...
// node_modules/@scalar/api-client/dist/v2/components/resize/Resize.vue.js
var Resize_default = _plugin_vue_export_helper_default(Resize_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-e2c54c18"]]);

// node_modules/@scalar/api-client/dist/v2/features/search/helpers/create-fuse-instance.js
...
// node_modules/@scalar/api-client/dist/v2/features/search/helpers/create-search-index.js
function createSearchIndex(documents) {
  const index = [];
  function processEntries(entriesToProcess, document2) {
    entriesToProcess.forEach((entry) => {
      addEntryToIndex(entry, index, document2);
      if ("children" in entry && entry.children) processEntries(entry.children, document2);
    });
  }
  documents == null ? void 0 : documents.forEach((document2) => {
    var _a2;
    return processEntries(((_a2 = document2["x-scalar-navigation"]) == null ? void 0 : _a2.children) ?? [], document2);
  });
  return index;
}
function addEntryToIndex(entry, index, document2) {
  var _a2;
  if (entry.type === "operation") {
    const operation = getResolvedRef(getPathItemOperation((_a2 = document2 == null ? void 0 : document2.paths) == null ? void 0 : _a2[entry.path], entry.method)) ?? {};
    index.push({
      type: "operation",
      title: entry.title,
      id: entry.id,
      ...
      entry,
      documentName: (document2 == null ? void 0 : document2.info.title) ?? ""
    });
    return;
  }
...
// node_modules/@scalar/api-client/dist/v2/features/search/hooks/use-search-index.js
...
// node_modules/@scalar/components/dist/components/ScalarHeader/ScalarHeaderButton.vue.script.js
var ScalarHeaderButton_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
...
// node_modules/@scalar/components/dist/components/ScalarHeader/ScalarHeaderButton.vue.js
var ScalarHeaderButton_default = ScalarHeaderButton_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuButton.vue.script.js
...
var ScalarMenuButton_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ScalarHeaderButton_default), { class: "gap-0.75 px-2 py-1.5 text-c-header-1 hover:bg-b-header-2" }, {
        default: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [renderSlot(_ctx.$slots, "logo", {}, () => [createVNode(unref(ScalarIcon_default), {
            icon: "Logo",
            size: "lg"
          })])]),
          _ctx.$slots.title ? (openBlock(), createElementBlock("span", _hoisted_2, [renderSlot(_ctx.$slots, "title")])) : createCommentVNode("", true),
          createBaseVNode("span", _hoisted_3, [renderSlot(_ctx.$slots, "label", {}, () => [createTextVNode(toDisplayString(__props.open ? "Close Menu" : "Open Menu"), 1)])]),
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuButton.vue.js
var ScalarMenuButton_default = ScalarMenuButton_vue_vue_type_script_setup_true_lang_default;
...
// node_modules/radix-vue/dist/namespaced/index.mjs
var DropdownMenu = {
  Root: uh,
  Trigger: dh,
  Portal: ch,
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuLink.vue.script.js
var _hoisted_12 = {
  key: 1,
  class: "size-3"
};
var ScalarMenuLink_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ScalarDropdownButton_default), mergeProps(unref(cx)("flex items-center"), {
        ...
        default: withCtx(() => [__props.icon ? (openBlock(), createBlock(unref(ScalarIconLegacyAdapter_default), {
          ...
          "thickness",
          "weight"
        ])) : (openBlock(), createElementBlock("div", _hoisted_12)), createBaseVNode("div", { class: normalizeClass(["flex items-center flex-1 min-w-0 truncate", __props.strong ? "font-medium" : "font-normal"]) }, [renderSlot(_ctx.$slots, "default")], 2)]),
        _: 3
      }, 16, ["is", "as"]);
    };
  }
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuLink.vue.js
var ScalarMenuLink_default = ScalarMenuLink_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuProduct.vue.script.js
var ScalarMenuProduct_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuProduct.vue.js
var ScalarMenuProduct_default = ScalarMenuProduct_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuProducts.vue.script.js
var ScalarMenuProducts_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", normalizeProps(guardReactiveProps(unref(cx)("flex flex-col"))), [
        createVNode(ScalarMenuProduct_default, {
          href: ((_a2 = __props.hrefs) == null ? void 0 : _a2.dashboard) ?? "https://dashboard.scalar.com",
        ...
        __props.showDocs || __props.selected === "docs" ? (openBlock(), createBlock(ScalarMenuProduct_default, {
          key: 0,
          href: ((_b = __props.hrefs) == null ? void 0 : _b.docs) ?? "https://docs.scalar.com",
        ...
        createVNode(ScalarMenuProduct_default, {
          href: ((_c2 = __props.hrefs) == null ? void 0 : _c2.editor) ?? "https://editor.scalar.com",
        ...
        createVNode(ScalarMenuProduct_default, {
          href: ((_d2 = __props.hrefs) == null ? void 0 : _d2.client) ?? "https://client.scalar.com",
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuProducts.vue.js
var ScalarMenuProducts_default = ScalarMenuProducts_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuSection.vue.script.js
var ScalarMenuSection_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuSection.vue.js
var ScalarMenuSection_default = ScalarMenuSection_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuResources.vue.script.js
var ScalarMenuResources_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuResources.vue.js
var ScalarMenuResources_default = ScalarMenuResources_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenu.vue.script.js
var ScalarMenu_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
  __name: "ScalarMenu",
  setup(__props) {
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenu.vue.js
var ScalarMenu_default = ScalarMenu_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuSupport.vue.script.js
var ScalarMenuSupport_vue_vue_type_script_setup_true_lang_default = defineComponent({
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuSupport.vue.js
var ScalarMenuSupport_default = ScalarMenuSupport_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuTeamProfile.vue.script.js
var _hoisted_13 = ["src"];
var _hoisted_22 = {
  key: 1,
  "aria-hidden": "true",
...
var ScalarMenuTeamProfile_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", normalizeProps(guardReactiveProps(unref(cx)("flex h-full items-center gap-1"))), [__props.src ? (openBlock(), createElementBlock("img", {
        ...
        role: "presentation",
        src: __props.src
      }, null, 8, _hoisted_13)) : (openBlock(), createElementBlock("div", _hoisted_22, [__props.label && __props.label.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(__props.label[0]), 1)], 64)) : (openBlock(), createBlock(unref(ScalarIconUsers_default), {
        key: 1,
        class: "size-3",
        weight: "bold"
      }))])), __props.label && __props.label.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_32, toDisplayString(__props.label), 1)) : createCommentVNode("", true)], 16);
    };
  }
});

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuTeamProfile.vue.js
var ScalarMenuTeamProfile_default = ScalarMenuTeamProfile_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuTeamPicker.vue.script.js
var ScalarMenuTeamPicker_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
  ...
  setup(__props, { emit: __emit }) {
    ...
    const model = computed({
      get: () => {
        var _a2;
        return (_a2 = __props.team) == null ? void 0 : _a2.id;
      },
      set: (v2) => emit("update:team", __props.teams.find((t) => t.id === v2))
    });
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(DropdownMenu).Sub, null, {
        default: withCtx(() => [createVNode(unref(ScalarMenuLink_default), mergeProps({
          icon: unref(ScalarIconUserSwitch_default),
          submenu: ""
        }, _ctx.$attrs), {
          default: withCtx(() => [_cache[2] || (_cache[2] = createBaseVNode("div", null, "Change team", -1)), createVNode(unref(ScalarIconCaretRight_default), {
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuWorkspacePicker.vue.script.js
var _hoisted_14 = { class: "flex h-full items-center gap-1 flex-1 truncate" };
var ScalarMenuWorkspacePicker_vue_vue_type_script_setup_true_lang_default = defineComponent({
  inheritAttrs: false,
  __name: "ScalarMenuWorkspacePicker",
  props: mergeModels({ workspaceOptions: {} }, {
    "modelValue": {},
    "modelModifiers": {}
  }),
  emits: mergeModels(["createWorkspace"], ["update:modelValue"]),
  setup(__props, { emit: __emit }) {
    const emit = __emit;
            ...
            default: withCtx(() => [createVNode(unref(DropdownMenu).RadioGroup, {
              ...
              default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.workspaceOptions, (group, groupIndex) => {
                return openBlock(), createElementBlock(Fragment, { key: groupIndex }, [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(group.options, (w2) => {
                    return openBlock(), createBlock(unref(DropdownMenu).RadioItem, {
                      key: w2.id,
                      as: unref(ScalarDropdownButton_default),
                      class: "group/item flex items-center",
                      ...
                      default: withCtx(() => [createBaseVNode("div", _hoisted_14, toDisplayString(w2.label), 1), createVNode(unref(ScalarListboxCheckbox_default), {
                        class: "ml-auto",
                        selected: w2.id === model.value
                      }, null, 8, ["selected"])]),
                      _: 2
                    }, 1032, ["as", "value"]);
                  }), 128)),
...
// node_modules/@scalar/components/dist/components/ScalarMenu/ScalarMenuWorkspacePicker.vue.js
var ScalarMenuWorkspacePicker_default = ScalarMenuWorkspacePicker_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/api-client/dist/v2/components/sidebar/SidebarMenu.vue.script.js
var SidebarMenu_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "SidebarMenu",
  props: {
    activeWorkspace: {},
    workspaces: {}
...
// node_modules/@scalar/api-client/dist/v2/components/sidebar/SidebarMenu.vue.js
var SidebarMenu_default = SidebarMenu_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/api-client/dist/v2/components/sidebar/Sidebar.vue.script.js
var _hoisted_15 = { key: 1 };
var Sidebar_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "Sidebar",
  props: mergeModels({
    sidebarState: {},
    layout: {},
      ...
      return openBlock(), createBlock(unref(Resize_default), {
        ...
        default: withCtx(() => [createVNode(unref(ScalarSidebar_default), {
          ...
          header: withCtx(() => [_cache[7] || (_cache[7] = createBaseVNode("div", { class: "mac:h-12 mac:app-drag-region h-2" }, null, -1)), createBaseVNode("div", { class: normalizeClass(["bg-sidebar-b-1 z-1 flex flex-col gap-1.5 px-3 pb-1.5", {
            ...
            "onSelect:workspace": _cache[2] || (_cache[2] = (id2) => emit("select:workspace", id2))
          }, {
            sidebarMenuActions: withCtx(() => [renderSlot(_ctx.$slots, "sidebarMenuActions")]),
            _: 3
          }, 8, ["activeWorkspace", "workspaces"])) : __props.layout === "modal" ? (openBlock(), createElementBlock("div", _hoisted_15)) : createCommentVNode("", true), createVNode(unref(ScalarIconButton_default), {
          ...
          }, null, 8, ["icon"])], 2)) : createCommentVNode("", true), isSearchVisible.value || __props.layout === "web" ? (openBlock(), createBlock(unref(ScalarSidebarSearchInput_default), {
            key: 1,
...
// node_modules/@scalar/api-client/dist/v2/components/sidebar/Sidebar.vue.js
var Sidebar_default = Sidebar_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/api-client/dist/v2/components/sidebar/SidebarToggle.vue.script.js
...
var SidebarToggle_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, [createBaseVNode("span", _hoisted_23, toDisplayString(isSidebarOpen.value ? "Hide" : "Show") + " sidebar", 1), (openBlock(), createElementBlock("svg", _hoisted_33, [
...
// node_modules/@scalar/api-client/dist/v2/components/sidebar/SidebarToggle.vue.js
var SidebarToggle_default = SidebarToggle_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/api-client/node_modules/@vueuse/integrations/useFocusTrap.mjs
function useFocusTrap(target, options = {}) {
  ...
  const targets = computed(() => {
    ...
    return toArray(_targets).map((el2) => {
      const _el = toValue(el2);
...
// node_modules/@scalar/api-client/dist/v2/components/modals/ModalClientContainer.vue.script.js
var _hoisted_17 = { class: "scalar scalar-app z-overlay relative" };
var ModalClientContainer_vue_vue_type_script_setup_true_lang_default = defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_17, [createBaseVNode("div", { class: normalizeClass(["scalar-container", { "scalar-client--open": __props.modalState.open }]) }, [createBaseVNode("div", mergeProps({
        ref_key: "client",
        ref: client,
...
// node_modules/@scalar/api-client/dist/v2/components/modals/ModalClientContainer.vue.js
var ModalClientContainer_default = _plugin_vue_export_helper_default(ModalClientContainer_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-77897d1c"]]);

// node_modules/@scalar/api-client/dist/v2/constants.js
var APP_VERSION = typeof OVERRIDE_PACKAGE_VERSION !== "undefined" ? OVERRIDE_PACKAGE_VERSION : "3.17.0";

// node_modules/@scalar/api-client/dist/v2/features/operation/Operation.vue.script.js
var _hoisted_18 = {
  key: 1,
  ...
  setup(__props) {
    const requestExample = computed(() => {
      ...
      const result = getRequestExampleContext(__props.workspaceStore, __props.documentSlug, {
        ...
        baseServerUrl: (_a2 = toValue(__props.options)) == null ? void 0 : _a2.baseServerURL,
        fallbackDocument: __props.document,
        isElectron: isElectron(),
        layout: __props.layout === "web" ? "web" : "other",
        servers: (_b = toValue(__props.options)) == null ? void 0 : _b.servers,
        appVersion: APP_VERSION,
        authentication: (_c2 = toValue(__props.options)) == null ? void 0 : _c2.authentication
      });
      return result.ok ? result.data : null;
    });
    const operation = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.operation) ?? null;
    });
    const workspaceCookies = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.cookies.workspace) ?? [];
    });
    const documentCookies = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.cookies.document) ?? [];
    });
    const servers = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.servers.list) ?? [];
    });
    const selectedServer = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.servers.selected) ?? null;
    });
    const serverMeta = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.servers.meta) ?? { type: "document" };
    });
    const securitySchemes = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.security.schemes) ?? {};
    });
    const selectedSecurity = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.security.selected) ?? {
        selectedIndex: -1,
        selectedSchemes: []
      };
    });
    const selectedSecuritySchemes = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.security.selectedSchemes) ?? [];
    });
    const securityRequirements = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.security.requirements) ?? [];
    });
    const authMeta = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.security.meta) ?? { type: "document" };
    });
    const defaultHeaders = computed(() => {
      var _a2;
      return ((_a2 = requestExample.value) == null ? void 0 : _a2.headers.default) ?? {};
    });
    const environments = computed(() => {
      var _a2;
      return Array.from(new Set(Object.keys({
        ...(_a2 = __props.document) == null ? void 0 : _a2["x-scalar-environments"],
        ...__props.workspaceStore.workspace["x-scalar-environments"]
      })));
    });
    const httpClients = computed(() => {
      var _a2;
      return mapHiddenClientsConfig((_a2 = toValue(__props.options)) == null ? void 0 : _a2.hiddenClients);
    });
    return (_ctx, _cache) => {
      var _a2, _b, _c2;
      return __props.path && __props.method && __props.exampleName && operation.value && __props.document ? (openBlock(), createBlock(unref(OperationBlock_default), {
        ...
        documentSecurity: ((_a2 = __props.document) == null ? void 0 : _a2.security) ?? [],
        documentSlug: __props.documentSlug,
        documentUrl: (_b = __props.document) == null ? void 0 : _b["x-scalar-original-source-url"],
        environment: __props.environment,
        environments: environments.value,
        eventBus: __props.eventBus,
        exampleKey: __props.exampleName,
        hideClientButton: ((_c2 = toValue(__props.options)) == null ? void 0 : _c2.hideClientButton) ?? false,
        ...
        "servers",
        "workspaceCookies"
      ])) : (openBlock(), createElementBlock("div", _hoisted_18, [..._cache[0] || (_cache[0] = [createBaseVNode("span", { class: "text-c-3" }, "Select an operation to view details", -1)])]));
    };
  }
});

// node_modules/@scalar/api-client/dist/v2/features/operation/Operation.vue.js
var Operation_default = Operation_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/api-client/dist/v2/hooks/use-scroll-lock.js
var useScrollLock = (element) => {
  const initialValue = ref("");
  const isLocked = ref(false);
  const lock = () => {
    const el2 = toValue(element);
    if (!el2) return;
    initialValue.value = el2.style.overflow;
    el2.style.overflow = "hidden";
  };
  const unlock = () => {
    const el2 = toValue(element);
    if (!el2) return;
    if (initialValue.value !== "") el2.style.overflow = initialValue.value;
    else el2.style.removeProperty("overflow");
  };
...
// node_modules/@scalar/api-client/dist/v2/features/modal/Modal.vue.script.js
var _hoisted_19 = {
  key: 0,
...
var Modal_vue_vue_type_script_setup_true_lang_default = defineComponent({
  __name: "Modal",
  props: {
    workspaceStore: {},
    document: {},
  ...
  setup(__props, { expose: __expose }) {
    ...
    const sidebarWidth = computed(() => {
      var _a2, _b;
      return ((_b = (_a2 = __props.workspaceStore) == null ? void 0 : _a2.workspace) == null ? void 0 : _b["x-scalar-sidebar-width"]) ?? DEFAULT_SIDEBAR_WIDTH;
    });
    const handleSidebarWidthUpdate = (width) => {
      var _a2;
      return (_a2 = __props.workspaceStore) == null ? void 0 : _a2.update("x-scalar-sidebar-width", width);
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(ModalClientContainer_default, { modalState: __props.modalState }, {
        default: withCtx(() => {
          ...
          return [createVNode(unref(ScalarToasts_default)), __props.document.value && ((_a2 = __props.path) == null ? void 0 : _a2.value) && ((_b = __props.method) == null ? void 0 : _b.value) ? (openBlock(), createElementBlock("main", _hoisted_19, [
            ...
            createVNode(Operation_default, {
              ...
              documentSlug: ((_c2 = __props.document.value["x-scalar-navigation"]) == null ? void 0 : _c2.name) ?? "",
              environment: environment.value,
              eventBus: __props.eventBus,
              exampleName: (_d2 = __props.exampleName) == null ? void 0 : _d2.value,
              isWebhook: __props.isWebhook.value,
              layout: "modal",
              method: (_e = __props.method) == null ? void 0 : _e.value,
              options: __props.options,
              path: (_f2 = __props.path) == null ? void 0 : _f2.value,
              plugins: __props.plugins,
          ...
          ])) : (openBlock(), createElementBlock("div", _hoisted_24, [..._cache[2] || (_cache[2] = [createBaseVNode("span", { class: "text-c-3" }, "No document selected", -1)])]))];
        }),
        _: 1
      }, 8, ["modalState"]);
    };
...
// node_modules/@scalar/api-client/dist/v2/features/modal/Modal.vue.js
var Modal_default = Modal_vue_vue_type_script_setup_true_lang_default;

// node_modules/@scalar/api-client/dist/v2/features/modal/helpers/create-api-client-modal.js
var modalAppCount = 0;
var createApiClientModal = ({ el: el2, eventBus = createWorkspaceEventBus({ debug: false }), mountOnInitialize = true, plugins = [], workspaceStore, options = {} }) => {
  var _a2, _b;
  ...
  for (const plugin of plugins) {
    (_b = (_a2 = plugin.lifecycle) == null ? void 0 : _a2.onInit) == null ? void 0 : _b.call(_a2);
    pluginUnsubscribes.push(subscribePluginEvents(eventBus, plugin));
  }
  app.onUnmount(() => {
    var _a3, _b2;
    for (const unsub of pluginUnsubscribes) unsub();
    for (const plugin of plugins) (_b2 = (_a3 = plugin.lifecycle) == null ? void 0 : _a3.onDestroy) == null ? void 0 : _b2.call(_a3);
  });
...
//# sourceMappingURL=chunk-4RCTY5KE.js.map
